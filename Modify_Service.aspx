<%@ Page Title="" Language="C#" MasterPageFile="~/Parent.master" AutoEventWireup="true" CodeFile="Modify_Service.aspx.cs" Inherits="Modify_Service" %>
...
<asp:DropDownList ID="dropId" runat="server" 
        onselectedindexchanged="dropId_SelectedIndexChanged"></asp:DropDownList>
    <asp:Button ID="button1" runat="server" Text="Find"/></td>
