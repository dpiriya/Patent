<%@ Page Language="C#" MasterPageFile="~/Parent.master" AutoEventWireup="true" CodeFile="FileCreation - Copy.aspx.cs" Inherits="FileCreation" Title="File Creation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
    ...
    <tr><td colspan="4" align="center" valign="middle" style="font-size:medium; text-decoration:underline;">
        PATENT FILE CREATION</td></tr>
    <tr> 
        <td class="style3">File Number</td>
        <td><asp:TextBox ID="txtFileNo"  Enabled="false" runat="server"></asp:TextBox></td>
        <td>Title</td>
        <td><asp:TextBox ID="txtTitle" runat="server" TextMode="MultiLine" Width="275px"></asp:TextBox></td></tr>
      <tr> 
      ...
      <tr> 
        ...
        <td><asp:TextBox ID="txtSApp" Width="275px" runat="server"></asp:TextBox></td></tr>
      <tr> 
      ...
      <td id="tdFirstInvent" runat="server">First Inventor Dept.</td><td><asp:DropDownList ID="ddlDept1" Width="70px" 
            ...
            <asp:TextBox ID="txtDept1" Width="200px" runat="server"></asp:TextBox> </td></tr>
        <tr>
...
<tr><td colspan="4">
<div style="text-decoration:underline;">List of Co Inventors</div><br />
...
<ItemTemplate>
    ...
    <td><asp:Label ID="lblDept" runat="server" BackColor="Transparent" BorderStyle="None" Width="250px" Text='<%#Eval("DeptOrgName")%>'></asp:Label></td>    
    <td><asp:Label ID="lblID" runat="server" BackColor="Transparent" BorderStyle="None" Width="90px" Text='<%#Eval("InventorID")%>'></asp:Label></td>
    <td><asp:Label ID="lblName" runat="server" BackColor="Transparent" BorderStyle="None" Width="250px" Text='<%#Eval("InventorName")%>'></asp:Label></td>
...
<asp:DropDownList ID="ddlSource" Width="50px" runat="server" AutoPostBack="true" 
        onselectedindexchanged="ddlSource_SelectedIndexChanged" ></asp:DropDownList>
    &nbsp;&nbsp;Direct Strategy&nbsp; <asp:DropDownList ID="dropstrategy" runat="server">
...
<tr>
<td class="style3">Write Up from IDF</td><td><asp:TextBox ID="txtWriteUp" runat="server" TextMode="MultiLine" Width="275px" onkeydown="return(event.keyCode !=13);" ></asp:TextBox></td>
