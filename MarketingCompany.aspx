<%@ Page Language="C#" MasterPageFile="~/Parent.master" AutoEventWireup="true" CodeFile="MarketingCompany.aspx.cs" Inherits="MarketingCompany" Title="Company Details" %>
...
<tr><td colspan="4" align="center" valign="middle" style="font-size:18px; color:Maroon;">
    Company Details</td></tr>
<tr><td>Company ID</td>
<td><asp:TextBox ID="txtCompanyID" Enabled="false" Width="100px" runat="server"></asp:TextBox>
</td>
...
<tr><td colspan="4"><a id="aBusinessArea" onserverclick="EnableBusiness" runat="server">
    Business Area </a>
<div id="divBusiness" runat="server" style="text-align:center;" visible="false">
...
<LayoutTemplate>
<table id="Table1" width="700px" align="center" runat="server"  style="text-align:left; border-color:#DEDFDE; border-style:none; border-width:1px;" cellpadding="5" cellspacing="0" border="1">
...
<tr><td colspan="4"><a id="aContact" runat="server" style="background-color:White;" onserverclick="aContact_ServerClick">
    Contact Person Details</a>
<div id="divContact" runat="server" style="text-align:center;" visible="false">
...
<LayoutTemplate>
<table id="Table1" width="850px" align="center" runat="server"  style="text-align:left; border-color:#DEDFDE; border-style:none; border-width:1px;" cellpadding="5" cellspacing="0" border="1">
    <tr id="Tr1" runat="server" style="background-color:#c8d59c">
    <th id="Th1" align="center" runat="server">Sl.No.</th>
