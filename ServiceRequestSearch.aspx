<%@ Page Language="C#" MasterPageFile="~/Parent.master" AutoEventWireup="true" CodeFile="ServiceRequestSearch.aspx.cs" Inherits="ServiceRequestSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    <h1 style="text-align: center; font-family: Times New Roman; font-size: 16px; font-weight: bold">Service Request Search</h1>
    <table class="neTable" align="center" width="400">
        <tr style="height: 95px; vertical-align: top;">
            <td align="center">
                <asp:Label ID="Label2" runat="server" Text="Select Field Name"></asp:Label><br />
                <asp:ListBox ID="lstColumn" runat="server"></asp:ListBox>
            </td>
            <td>
                <asp:Label ID="Label3" runat="server" Text="Enter Field Value"></asp:Label><br />
                <asp:TextBox ID="txtValue" Width="200px" Height="50px" TextMode="MultiLine" runat="server"></asp:TextBox><br />
                <asp:Label ID="lblHelp" Font-Size="12px" Font-Bold="false" runat="server" Width="250px"></asp:Label></td>
        </tr>
        <tr>
            <td colspan="2" align="center">
                ...
                <asp:Button ID="btnRemoveVal" runat="server" Text="Remove"
                    Width="70px" BackColor="Brown" ForeColor="Yellow" Font-Bold="true" Font-Names="Times new roman" /></td>
        </tr>
        <tr>
            <td colspan="2" align="center">
        ...
        <tr>
            <td colspan="2" align="center">Select Your Report Columns</td>
        </tr>
        ...
        <tr>
            <td colspan="2" align="center">
                <table width="410px">
                    ...
                    <tr align="center">
                        <td>
                            <asp:ListBox ID="lstTable" Width="150px" runat="server"></asp:ListBox>
                        </td>
                        <td valign="middle">
                        ...
                        <td>
                            <asp:ListBox ID="lstSelected" Width="150px" runat="server"></asp:ListBox></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="center">
                ...
                <asp:Button ID="btnClear" runat="server" Text="Clear" BackColor="Brown" ForeColor="Yellow" Font-Bold="true" Font-Names="Times new roman" OnClick="btnClear_Click"/></td>
        </tr>
    </table>
</asp:Content>
