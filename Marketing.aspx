<%@ Page Language="C#" MasterPageFile="~/Parent.master" AutoEventWireup="true" CodeFile="Marketing.aspx.cs" Inherits="Marketing" Title="New Marketing Entry" %>
...
$(document).ready(function(){
    ...
    data: "{'company':'" + $("#<%=txtCompany.ClientID %>").val() + "'}",
    dataType: "json",
...
function Verify()
{
   ...
   if (r==true)
   {
       if (document.getElementById('<%= txtTitle.ClientID%>').value== "")
        {
            alert('Marketing Title can not be empty');
            return false;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
    ...
    <tr><td colspan="4" align="center" valign="middle" style="font-size:18px; color:Maroon;">
        New Marketing Project</td></tr>
    <tr><td>Marketing Project Number</td>
    <td><asp:TextBox ID="txtMktgProjNo" Enabled="false" runat="server"></asp:TextBox>
    </td>
...
<ItemTemplate>
    <tr id="Tr2" runat="server" style="background-color:White">
    <td><asp:Label ID="lblSlNo"  Text='<%#Eval("SlNo")%>' runat="server"></asp:Label></td>
    <td><asp:TextBox ID="lblActivityDt" BackColor="Transparent" BorderStyle="None" Width="100px" ReadOnly="true" Text='<%#Eval("ActivityDt")%>' runat="server"></asp:TextBox></td>
...
<EditItemTemplate>
    ...
    <td><asp:TextBox ID="txtEdActivityDt" BorderStyle="None" Width="100px" Text='<%#Eval("ActivityDt")%>' runat="server"></asp:TextBox></td>
