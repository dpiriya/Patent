<%@ Page Language="C#" MasterPageFile="~/Parent.master" AutoEventWireup="true" CodeFile="ReportSelection.aspx.cs" Inherits="PaymentReport" %>
...
<table align="center" class="neTable" cellpadding="20px"  cellspacing="10px">
    ...
    <tr><td runat="server" id="lblTitle" colspan="2" align="center" valign="middle" style="font-size:medium; text-decoration:underline;">PAYMENT REPORT</td></tr>
    <tr><td runat="server" id="lblFile">File Number</td>
