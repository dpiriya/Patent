...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            string sql = "select column_name from information_schema.columns where table_name='CoInventorDetails' order by ordinal_position";
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        ...
        sql = "select " + sql + " from CoInventorDetails "+dFilter2;
        SqlCommand cmd = new SqlCommand();
        SqlDataReader dr;
        cmd.CommandType = CommandType.Text;
        cmd.Connection = cnp;
        ...
        ge.MakeExcel(dt, "CoInventorDetails");
        cnp.Close();  
    }
}
