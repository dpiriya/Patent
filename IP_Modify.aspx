<%@ Page Language="C#" MasterPageFile="~/Parent.master" AutoEventWireup="true" CodeFile="IP_Modify.aspx.cs" Inherits="IP_Modify" Title="International Patent Modification" %>
...
function Verify()
{
    ...
    if (r==true)
    {
        ...
        var SelSubFileNo=document.getElementById('<%=ddlSubFileNo.ClientID%>');
        var SelSubVal= SelSubFileNo.options[SelSubFileNo.selectedIndex].value;
        if (SelSubVal== "")
        {
...
<table align="center" class="neTable" cellpadding="12px"  width="970px" cellspacing="10px">
    ...
    <tr><td colspan="4" align="center" valign="middle" style="font-size:medium; text-decoration:underline;">
        INTERNATIONAL PATENT MODIFICATION</td></tr>
    <tr><td>File Number</td>
        <td><asp:DropDownList ID="ddlFileNo" runat="server" 
                 AutoPostBack="true" onselectedindexchanged="ddlFileNo_SelectedIndexChanged">
            </asp:DropDownList>
        </td>
    <td>Sub File Number</td>
        <td><asp:DropDownList ID="ddlSubFileNo" runat="server" AutoPostBack="true" onselectedindexchanged="ddlSubFileNo_SelectedIndexChanged">
            </asp:DropDownList>
    </td></tr>
    <tr> 
    <td>Request Date</td>
